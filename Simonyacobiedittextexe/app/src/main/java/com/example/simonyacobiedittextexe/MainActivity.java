package com.example.simonyacobiedittextexe;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void check1(View view)
    {
        ...
        if ( Integer.parseInt(answer1) != (rand_num1 + rand_num2))
            wrong1.setImageResource(R.drawable.x);
        else
        {
            wrong1.setImageResource(R.drawable.chack);
            sum++;
        }
    ...
    public void check2(View view)
    {
        ...
        if ( Integer.parseInt(answer2) != (rand_num3 + rand_num4))
            wrong2.setImageResource(R.drawable.x);
        else
        {
            wrong2.setImageResource(R.drawable.chack);
            sum++;
        }
    ...
    public void check3(View view)
    {
        ...
        {
            wrong3.setImageResource(R.drawable.x);
            rand_num1 = (rand_num5 + rand_num6);
        }
        else {
            wrong3.setImageResource(R.drawable.chack);
            sum++;
        }
